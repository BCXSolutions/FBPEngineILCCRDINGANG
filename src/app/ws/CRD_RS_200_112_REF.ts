...
/*
 * Service : CRD_RS_200_112_REF.ts 
 * Objetivo: Llamado a Web Service REST
 * Autor   : Generado por BcxWSql (BCX Solutions) a partir de CRD_RS_200_112_REF.sql
 * Fecha   : 21/04/2020 11:00:46
 */
@Injectable()
export class CRD_RS_200_112_REF 
{
    constructor (private hostService: CmWsHostService) {}
  /**
   * Invoca a CRD_RS_200_112_REF
   ...
   */                
	...
	{
   // URL to web Service
    const url: string        = this.hostService.getRuta() + '/FBP/CRD_RS_200_112_REF';  
   const data: any = {
wss_num_opr: wss_num_opr, wss_tas_tip_tas: wss_tas_tip_tas, wss_tas_val_tas: wss_tas_val_tas, wss_tas_spr: wss_tas_spr, wss_ali_pla_ref: wss_ali_pla_ref, wss_ali_rgd_ref: wss_ali_rgd_ref, wss_ali_cnf_ref: wss_ali_cnf_ref, wss_fec_pro: wss_fec_pro, wss_tas_spr_cof: wss_tas_spr_cof, wss_tas_spr_spr: wss_tas_spr_spr, wss_usercode: wss_usercode
	};
