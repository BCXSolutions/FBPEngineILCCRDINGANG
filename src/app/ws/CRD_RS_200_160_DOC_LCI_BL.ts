...
/*
 * Service : CRD_RS_200_160_DOC_LCI_BL.ts 
 * Objetivo: Llamado a Web Service REST
 * Autor   : Generado por BcxWSql (BCX Solutions) a partir de CRD_RS_200_160_DOC_LCI_BL.sql
 * Fecha   : 15/04/2020 10:55:35
 */
@Injectable()
export class CRD_RS_200_160_DOC_LCI_BL 
{
    constructor (private hostService: CmWsHostService) {}
  /**
   * Invoca a CRD_RS_200_160_DOC_LCI_BL
   ...
   */                
	...
	{
   // URL to web Service
    const url: string        = this.hostService.getRuta() + '/FBP/CRD_RS_200_160_DOC_LCI_BL';  
   const data: any = {
